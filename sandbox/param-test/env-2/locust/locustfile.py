"""
PQC Benchmarking PoC — Locust load test script.
...
log = logging.getLogger("pqc-locust")
...
def on_request(request_type, name, response_time, response_length,
    ...
    """Log PQC-relevant details for every request."""
    if exception:
...
class PQCUser(HttpUser):
    """
    Simulates a user making HTTPS requests over a PQ/hybrid TLS 1.3 channel.
